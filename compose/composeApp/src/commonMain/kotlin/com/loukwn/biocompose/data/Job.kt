...
fun Job.durationIn6Months(): Float = started.diffIn6MonthsWith(ended)

fun Job.durationString(): String {
    val startPart = "${getMonthNameForNumber(started.month)} ${started.year}"
    val endPart =
        if (ended.year == getCurrentYear() && ended.month == getCurrentMonth()) {
            "Present"
        } else {
...
val myJobs by lazy {
    listOf(
        Job(
            ...
            location = "London, UK",
            description =
                "Helping people invest their money and secure their future.\n\n" +
                    "Currently working at Nutmeg as an Android Engineer where I develop " +
                    "initiatives (and lead some of them) as well as actively contribute to the " +
        ...
        Job(
            ...
            location = "London, UK",
            description =
                "Helped millions of Muslims find their special one.\n\nFor more than " +
                    "3 years I was part of the Muzz Android team, tasked with shipping features " +
                    "that provided a lot of value to the customers, while at the same time " +
                    "focusing on refactoring the app and improving its performance.",
        ...
        Job(
            ...
            description =
                "Helped university students throughout their academic journey.\n\nWas " +
                    "part of a small startup that published two social media applications " +
                    "catering both to the studying and socializing aspects of the university " +
                    "student life.",
