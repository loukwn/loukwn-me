...
val myProjects by lazy {
    listOf(
        Project(
            title = "StageStepBar",
            description =
                "A library I created that assists in the creation of custom progress " +
                    "bars with stages and configurable steps between these stages. It is " +
                    "available as both a traditional Android View and a Composable.",
        ...
        Project(
            title = "GifSound It",
            description =
                "Combine GIFs with sound.\n\nMy Kotlin workspace where I try to " +
                    "experiment with things like new architectures, libraries, software " +
                    "patterns etc. Currently archived due to Reddit API changes but could " +
                    "continue working on it at some point.",
            technologies = listOf(SimpleIcons.Android, SimpleIcons.Kotlin),
            links =
                listOf(
